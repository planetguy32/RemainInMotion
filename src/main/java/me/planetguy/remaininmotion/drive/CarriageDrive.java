...
public class CarriageDrive extends RIMBlock {
	public CarriageDrive() {
		...
		CarriageEngineEntity.class, CarriageMotorEntity.class, CarriageControllerEntity.class,
				CarriageTranslocatorEntity.class, CarriageTransduplicatorEntity.class, CarriageAdapterEntity.class,
	...
	public IIcon getIcon(int Side, int Meta) {
		try {
			if (Meta == Types.Rotator.ordinal()) { return CarriageRotatorEntity.icons[0][Side]; }
