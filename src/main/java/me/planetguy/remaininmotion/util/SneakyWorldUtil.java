...
public abstract class SneakyWorldUtil {
	public static void SetBlock(net.minecraft.world.World World, int X, int Y, int Z, Block spectre, int Meta) {
		...
		if (storageArrays[LayerY] == null) {
			storageArrays[LayerY] = new net.minecraft.world.chunk.storage.ExtendedBlockStorage((LayerY) << 4,
	...
	public static void RefreshBlock(net.minecraft.world.World World, int X, int Y, int Z,
			net.minecraft.block.Block OldId, Block NewId) {
