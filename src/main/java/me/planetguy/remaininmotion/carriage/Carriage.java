...
public class Carriage extends RIMBlock {
	public Carriage() {
		super(Blocks.planks, CarriageItem.class, HarvestToolTypes.Hatchet, FrameCarriageEntity.class,
				SupportCarriageEntity.class, StructureCarriageEntity.class, PlatformCarriageEntity.class,
				TemplateCarriageEntity.class);
	}
	...
	public boolean rotateBlock(World worldObj, int x, int y, int z, ForgeDirection axis) {
		try {
			ArrayRotator.rotate(((CarriageEntity) worldObj.getTileEntity(x, y, z)).SideClosed, axis);
			return true;
		} catch (Exception e) {
			e.printStackTrace();
		}
