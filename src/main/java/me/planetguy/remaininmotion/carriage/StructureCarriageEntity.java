...
public class StructureCarriageEntity extends CarriageEntity {
	...
	public StructureCarriageEntity FollowEdgeToCorner(EdgeTypes EdgeType, StructureCarriageEntity Origin,
	...
	public StructureCarriageEntity FollowEdgeToCorner(EdgeTypes EdgeType, CornerTypes CornerType,
			StructureCarriageEntity Origin, Directions Direction) throws CarriageMotionException {
	...
	public StructureCarriageEntity AssertCoordsMatch(StructureCarriageEntity A, StructureCarriageEntity B)
	...
	public StructureCarriageEntity AssertCoordsMatch(StructureCarriageEntity A, StructureCarriageEntity B,
			StructureCarriageEntity C) throws CarriageMotionException {
	...
	public void fillPackage(CarriagePackage Package) throws CarriageMotionException {
		...
		StructureCarriageEntity NextAlongX = FollowEdgeToCorner(EdgeTypes.X, CornerType.NextAlongAxisX(), this,
				CornerType.ToNextAlongX);

		StructureCarriageEntity NextAlongY = FollowEdgeToCorner(EdgeTypes.Y, CornerType.NextAlongAxisY(), this,
				CornerType.ToNextAlongY);

		StructureCarriageEntity NextAlongZ = FollowEdgeToCorner(EdgeTypes.Z, CornerType.NextAlongAxisZ(), this,
