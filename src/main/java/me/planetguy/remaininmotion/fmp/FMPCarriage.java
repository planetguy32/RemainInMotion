...
public class FMPCarriage extends McBlockPart implements JNormalOcclusion, Moveable, ICloseable {
	...
	public FMPCarriage() {
		if (FMLCommonHandler.instance().getSide().isClient()) renderer = new FMPRenderer();
	}
	...
	public static final Cuboid6[]	cubeOutsideEdges	= new Cuboid6[] { // not
			...
			new Cuboid6(0 - e, 0 - e, 0 - e, l, 1 + e - l, l), new Cuboid6(0 - e, 0 - e, 0 - e, l, l, 1 + e),
