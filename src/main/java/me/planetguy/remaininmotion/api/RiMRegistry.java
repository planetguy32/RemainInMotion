...
public class RiMRegistry {
	 ...
	 * To register something as a frame carriage, use FrameCarriageMatcher instead - otherwise
	 * other registered frame carriages will not be interoperable with this.
	 * @param m
	...
	/**
	 * Registers a way to get Closeables from a block. Closeables specify which sides to treat as closed.
	 * @param factory
	 */
