...
public abstract class CarriageEntity extends TileEntity implements Moveable
{
	...
	{
		DecorationId = Block.getIdFromBlock(CarriageItem . GetDecorationId ( Item ) );
	...
	{
		EmitDrop ( Block , CarriageItem . Stack ( Meta , Tier , Block.getBlockById(DecorationId) , DecorationMeta ) ) ;
	}
	...
	public abstract void fillPackage ( CarriagePackage Package ) throws me.planetguy.remaininmotion.util.CarriageMotionException ;
}
