...
public class MotiveSpectreEntity extends TileEntity {
	...
	public void validate() {
		if (worldObj instanceof WorldServer) Teleporter = new TeleportativeSpectreTeleporter(worldObj);
	}
	...
	public void doRelease() {
		...
		try {
			CarriageDriveEntity Drive = (CarriageDriveEntity) worldObj.getTileEntity(DriveRecord.X, DriveRecord.Y,
					DriveRecord.Z);
	...
	public void ReadServerRecord(net.minecraft.nbt.NBTTagCompound TagCompound) {
...

		{
			...
			for (int Index = 0; Index < BodyBlockCount; Index++) {
				net.minecraft.nbt.NBTTagCompound BodyBlockRecord = (net.minecraft.nbt.NBTTagCompound) BodyRecord
	...
	public void ReadClientRecord(net.minecraft.nbt.NBTTagCompound TagCompound) {
		...
		for (int Index = 0; Index < CapturedEntityCount; Index++) {
			net.minecraft.nbt.NBTTagCompound EntityRecord = (net.minecraft.nbt.NBTTagCompound) CapturedEntityRecords
					.getCompoundTagAt(Index);
