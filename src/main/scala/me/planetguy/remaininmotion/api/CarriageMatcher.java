 ...
 * 
 * Note that the simple case of tile entities that are Moveables and match things with the same ID and meta is covered by RiM by default, so a CarriageMatcher is unnecessary.
 * @author bill
 *
 */
